...
$this->menu=array(
	  ...
	  array('label'=>'入金の修正', 'url'=>array('update', 'id'=>$model->id, 'year'=>$year)),
	  array('label'=>'入金の削除', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id, 'year'=>$year),'confirm'=>'この項目を削除してよろしいですか?')),
